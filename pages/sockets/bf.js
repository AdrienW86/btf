...
import Banner from '@/assets/bf-sockets.png'
  ...
  return (
    <section className={styles.container}>
      <section className={styles.banner}>
        <h1 className={styles.h1}>Collection BF</h1>
        <p className={styles.description}>
          Découvrez notre collection de chaussettes BF. Livraison rapide et gratuite à partir de 100€ d'achats.
        </p>
        <Image
          src={Banner}
          fill
